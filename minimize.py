...
def minimize(X, args, f, grad=None, maxnumlinesearch=None, maxnumfuneval=None, red=1.0, verbose=True):
    ...
    if grad is None:
       raise ValueError("Grad must be either True (if f returns grad) or a function")
